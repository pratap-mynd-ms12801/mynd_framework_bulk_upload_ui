...
$(function() {
    ...
    var chart = new ApexCharts(document.querySelector("#apex-SocialMediaTraffic"),options); chart.render();
    ...
    var chart = new ApexCharts(document.querySelector("#apex-SessionsbyDevice"),options); chart.render();
});
